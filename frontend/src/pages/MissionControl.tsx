  ...
  return (
    <div className="flex h-full bg-[#080d18] text-slate-100 overflow-hidden font-mono">
      ...
      <div className="w-80 flex-shrink-0 flex flex-col border-r border-slate-800/60">
        ...
        <div className="px-3 py-2.5 border-t border-slate-800/40">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-shrink-0 h-[162px] flex flex-col border-b border-slate-800/60">
          ...
          <div className="flex gap-2 px-3 py-2 overflow-x-auto flex-1 items-start content-start">
            {fleet.map(bot => {
              ...
              return (
                <div key={bot.id} className="flex-shrink-0 flex items-center gap-2 bg-slate-800/50 border border-slate-700/40 rounded-md px-3 py-2 min-w-[148px]">
                  <div className={clsx('w-2 h-2 rounded-full flex-shrink-0', modeColor)} />
                  ...
                  <span className={clsx('text-[10px] font-bold font-mono flex-shrink-0',
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 flex flex-col min-w-0 p-3">
            ...
            {/* Selected bot detail — conditional */}
            {selectedBot && (
            ...
            {/* Activity card — naturally shorter now, sits below two strips */}
