  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          ...
          NOTE: Market Regime card lives on Manual Trades (Session XXXVIII —
          not here). It was briefly mis-mounted here mid-session and then
          relocated to its correct home at the top of /trades.
          ══════════════════════════════════════════════════════════════════ */}
