 ...
 *
 * Sections:
 *  1. Header — name, ticker, UID, TaoBot status badge
          ...
          {detail.is_monitored && (
            <div className="mt-3 flex items-start gap-2 bg-accent-green/8 border border-accent-green/25 rounded-lg px-3 py-2.5">
              ...
              <p className="text-xs text-accent-green/90 font-mono">
                TaoBot actively stakes on this subnet. Consensus-approved signals from the OpenClaw engine
                route TAO in and out via the configured validator. Performance data feeds directly into
                the Strategy Leaderboard and P&L Summary.
              </p>
            </div>
          )}
        </div>
