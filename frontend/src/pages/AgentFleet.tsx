...
import { RefreshCw, BarChart2, CheckCircle2, XCircle, TrendingUp, TrendingDown, Minus, ExternalLink, ChevronLeft, ChevronRight, Zap, ArrowUp, ArrowDown } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col h-full bg-[#080d18] text-slate-100 font-mono overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* ── Fleet Health color legend — consolidated (3 colors only, per Session XXV) ── */}
        {/* LEADERBOARD / BFT CONSENSUS / GATE PASSED / PAPER legend items relocated → Strategies page */}
        <div className="px-6 py-3 border-b border-slate-800/40 flex flex-wrap gap-x-8 gap-y-2">
      ...
      {/* Right panel — 30% width, proportional */}
      <div className="w-[30%] min-w-[260px] max-w-[420px] flex-shrink-0 border-l border-slate-800/60 flex flex-col overflow-hidden">
